...
export const imgUploadRules: string[] = [
  "egy darab képet tudsz feltölteni 24 órán belül",
  "png vagy jpg formátmú",
  "a hosszabbik éle maximum 2000px hosszú",
  "200-300 dpi",
  "maximum 0.5MB (~500 kB) a nagysága",
];
